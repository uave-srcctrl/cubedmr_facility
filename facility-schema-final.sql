...
-- Tables: Facilities, Facility Data Report, user_settings, wound_encounter_edits, wound_encounters, wound_encounters_imports_logs
--
USE curisec;
GO

-- Ensure facility schema exists
...
-- Function: fn_normalize_etiology
...
Procedure: etiology_distribution
...
-- Procedure: outcome_report_global
...
Procedure: report_FacilityAcuityIndex
...
-- Procedure: report_FacilityWoundOutcomeByDOS
...
-- Procedure: report_WoundHealingStatus
...
-- Procedure: report_WoundsByStatus
...
-- Procedure: sp_facility_import_excel_wounds
...
Procedure: sp_GET_FacilityPatientDetail
...
-- Procedure: sp_GetEnabledEncounterDates
...
Procedure: sp_LST_FacilitiesByWounds
...
Procedure: sp_LST_FacilityPatients
...
Procedure: sp_UpdateWoundEncounter
...
Procedure: wound_reduction_median
...
Procedure: woundcare_round_summary
