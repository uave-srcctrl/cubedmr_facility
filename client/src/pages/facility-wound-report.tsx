...
export default function FacilityWoundReport() {
  ...
  const { data, isLoading, error, refetch } = useQuery({
    ...
    queryFn: async () => {
      const url = `${LOCAL_API.FACILITY_WOUND_REPORT}`;
      ...
      console.log('[FacilityWoundReport] Calling endpoint with:');
      console.log('[FacilityWoundReport] URL:', url);
      console.log('[FacilityWoundReport] Headers:', headers);
      console.log('[FacilityWoundReport] facilityId:', facilityId);
      console.log('[FacilityWoundReport] email:', email);
      console.log('[FacilityWoundReport] Date range:', startDateStr, 'to', endDateStr);

      // Send as POST with body to pass email and date range
      ...
      // lstWoundEncounters returns an array of wound encounters
