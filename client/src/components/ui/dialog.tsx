...
// Nested dialog content that renders above other dialogs using React portal
// Uses DialogPortal from Radix for proper event handling (click outside to close)
