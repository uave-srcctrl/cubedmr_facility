...
import { DeterioratingPatient, DeterioratingWound } from "@/hooks/use-patients";
import { LineChart, Line, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer, ReferenceLine, ReferenceArea } from "recharts";

interface DeterioratingWoundsModalProps {
  deterioratingPatients: DeterioratingPatient[];
  totalWounds: number;
...
export function DeterioratingWoundsModal({
  ...
  // Edit mode state
  const [editingWound, setEditingWound] = useState<DeterioratingWound | null>(null);
  ...
  // Get selected encounter date for a wound
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <DialogDescription className="mt-1">
                Wounds with deteriorating progress status
              </DialogDescription>
            </div>
          </div>
          {!isLoading && (
            <div className="flex gap-4 mt-4">
              ...
              <Badge variant="destructive" className="text-sm px-3 py-1">
                ...
                {totalWounds} Wound{totalWounds !== 1 ? "s" : ""} Deteriorating
              </Badge>
            </div>
          )}
        </DialogHeader>
        ...
        <div className="space-y-4 pt-4">
          {isLoading ? (
            <EcgLoader title="Loading deteriorating wounds..." minHeight="min-h-[200px]" />
              ...
              <CardContent className="pt-6">
                <div className="flex flex-col items-center justify-center py-8 text-center">
                  ...
                  <p className="text-lg font-medium text-green-700">
                    No Deteriorating Wounds
                  </p>
                  <p className="text-muted-foreground mt-1">
                    All wounds are stable or improving
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <div className="space-y-4">
              {deterioratingPatients.map((patient) => (
                <Card 
                    ...
                    <div className="space-y-2">
                      {patient.wounds.map((wound, idx) => {
                        ...
                        const chartData = history.map(h => ({
                          dos: h.dos,
                          surface: toNum(h.surface),
                          displayDate: formatDate(h.dos),
                        }));
                        ...
                        >
                              ...
                              <div className="flex items-center gap-2">
                                <Button
                                  ...
                                  onClick={(e) => { 
                                    ...
                                    const editableWound: DeterioratingWound = {
                                      ...wound,
                          ...
                          <CardContent className="pt-4">
                            ...
                            <div className="mb-4 pb-4 border-b">
                              ...
                              {/* Wound Metrics Grid - Same as Critical Cases */}
                          ...
                          {wound.encounter_history && wound.encounter_history.length > 1 && (() => {
                                ...
                                const surfaceChartData = history.map((e, i) => {
                                ...
                                const chartDisplayData = [...surfaceChartData].reverse();
